...
function buildPayload(consentData) {
  return {
    ...
    consent_timestamp: consentData.consentTimestamp,
    legal_consent_timestamp: consentData.legalConsentTimestamp,

    consent_type: 'Paid Booking Consent',
    legal_bundle_version: 'legal-bundle-apr-2026-v1',
    documents_count: 5,
    expected_documents_count: 5,

    source_page: consentData.sourcePage,
    ...
    next_step: consentData.nextStep,
    intended_redirect_after_payment: consentData.intendedRedirectAfterPayment,
    ...
    legal_docs: consentData.legalDocsAccepted,
